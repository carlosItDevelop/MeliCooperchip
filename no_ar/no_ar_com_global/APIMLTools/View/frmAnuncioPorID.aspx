<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAnuncioPorID.aspx.cs" Inherits="View.FrmAnuncioPorId" %>
                    ...
                    <form class="form-inline" role="form" runat="server">
                        <div>
                                <table Style="text-align: center">
                                    <tr>
                                        <td><strong>Cooperchip Sys - Dados de Um Anúncio Específico<br />
                                            <br />
                                        </strong></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtItemsId" runat="server"></asp:TextBox>
                                            <asp:Button ID="btnBuscaAnuncio"  CssClass="form-control"  runat="server" Text=".:: Enviar ::." OnClick="btnBuscaAnuncio_Click" />
                                        </td>
                                    </tr>
                                    <tr>
