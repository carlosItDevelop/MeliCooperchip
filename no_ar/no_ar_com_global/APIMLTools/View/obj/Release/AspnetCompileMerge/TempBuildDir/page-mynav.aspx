<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="page-mynav.aspx.cs" Inherits="view.page_mynav" %>
        ...
        <div id="header" class="page-navbar">
            ...
            <div id="navbar-no-collapse" class="navbar-no-collapse">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="/info.asp" class="spark-info spark clearfix"><span class="number">Info</span> server</a>
                    </li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <a href="#" data-toggle="dropdown">
                            <i class="fa fa-cog" data-toggle="tooltip" data-placement="bottom" title="Configurações da Template"></i>
                    ...
                    <li>
                        <a id="toggle-right-sidebar" href="#" class="tipB" title="Mostrar/Ocultar Sidebar Direita">
                            
                            <i class="fa fa-cogs"></i>                       

                            <span class="sr-only">Mostrar/Ocultar Sidebar Direita</span>
                        </a>
                    </li>
                </ul>
                <!-- / top right nav -->
