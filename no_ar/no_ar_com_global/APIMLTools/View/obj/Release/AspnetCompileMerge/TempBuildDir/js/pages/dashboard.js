...
$(document).ready(function() {
	...
	$('#world-map').vectorMap({
	    ...
	    markers: [
			...
			{latLng: [-8.070107, -34.876099], name: 'Recife'},
			{ latLng: [-9.687398, -35.711060], name: 'Maceio' },
			{ latLng: [-12.999205, -38.504333], name: 'Salvador' },
			{latLng: [-22.911632, -43.188286], name: 'Rio De Janeiro'},
			{ latLng: [-30.088108, -51.207275], name: 'Porto Alegre'},
            { latLng: [-24.866503, -51.954346], name: 'Parana'},
            { latLng: [-23.644524, -46.658936], name: 'Sao Paulo'},
            { latLng: [-20.014645, -43.934326], name: 'Belo Horizonte'},
            { latLng: [-1.504954, -48.488159], name: 'Belem' },
            { latLng: [-16.762468, -49.251709], name: 'Goiania'}
