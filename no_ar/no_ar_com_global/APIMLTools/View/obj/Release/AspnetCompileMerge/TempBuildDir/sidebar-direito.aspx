<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sidebar-direito.aspx.cs" Inherits="view.sidebar_direito" %>
            ...
            <aside id="right-sidebar" class="right-sidebar hidden-md hidden-sm hidden-xs">
                ...
                <div class="sidebar-inner">
                   ...
                   <!--         <li class="active">
                                    <a href="#activity" data-toggle="tab"><i class="fa fa-flash"></i> </a>
                                </li>   -->
                                <li>
                                    <a href="#notify" data-toggle="tab"><i class="glyphicon glyphicon-bullhorn"></i> </a>
                                </li>
                                <li>
                            ...
                            <div id="rstab-content" class="tab-content">
                                ...
                                <%--<div class="tab-pane fade active in" id="activity">
                                    <ul class="timeline timeline-icons timeline-sm">
                                        ...
                                        <li>
                                            <p>
                                                <a href="#">Carlos Alberto</a> Alterar sua foto
                                                <span class="timeline-icon"><i class="l-basic-photo"></i></span>
                                                <span class="timeline-date">2 de Dez, 05:17</span>
                                            </p>
                                        </li>
                                        <li>
                                            <p>
                                ...
                                <div class="tab-pane fade active in" id="notify">
                                    <ul class="timeline timeline-icons timeline-sm">
                                        <li>
                                            <p>
                                                <a href="#">Jonh Doe</a> attached new <a href="#">file</a>
