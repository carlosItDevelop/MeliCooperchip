<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmResumo.aspx.cs" Inherits="view.frmResumo" %>
        ...
        <% Server.Execute("sidebar-direito.aspx"); %>
            ...
            <div id="page-header" class="clearfix">
                <div class="page-header">
                    <h2>Meu Resumo Recente</h2>
                    <span class="txt">Meu Resumo recente no ML.</span>
                </div>
                                     ...
                                     <div style="padding: 10px; margin: 15px 15px;">
                                        ...
                                        <div class="panel panel-default plain toggle panelMove panelClose panelRefresh">
                                            ...
                                            <div class="panel-heading white-bg">
                                                <h4 class="panel-title">Meu Resumo Recente:</h4>
                                            </div>
