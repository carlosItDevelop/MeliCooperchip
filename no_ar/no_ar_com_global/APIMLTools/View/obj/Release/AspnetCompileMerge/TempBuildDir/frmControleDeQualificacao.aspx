<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmControleDeQualificacao.aspx.cs" Inherits="view.frmControleDeQualificacao" %>
        ...
        <% Server.Execute("sidebar-direito.aspx"); %>
            ...
            <div id="page-header" class="clearfix">
                <div class="page-header">
                    <h2>Qualificações</h2>
                    <span class="txt">Controle de Qualificações.</span>
                </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><i class="fa fa-list-alt"></i> APIML | Tools - Qualificações</h4>
                                    </div>
                                        ...
                                        <div style="padding: 10px; margin: 15px 15px;">
                                            <form class="form-inline" role="form" runat="server">
                                                    <label class="control-label" for="">Escolha:</label>&nbsp;&nbsp;
                                                        ...
                                                        <asp:DropDownList CssClass="fancy-select form-control" ID="cboStatus" runat="server">
                                                            <asp:ListItem Value="todas">&lt;&lt; TODAS &gt;&gt;</asp:ListItem>
                                                            <asp:ListItem Value="aguardandoqualificacao">Aguardando Qualificação do Cliente</asp:ListItem>
                                                            <asp:ListItem Value="aqualificar">Aguardando Nossa Qualificação</asp:ListItem>
                                                        </asp:DropDownList>
&nbsp;
                                                    <asp:Button CssClass="btn btn-success ml10" ID="btnEnviar" runat="server" Text=":: Buscar ::" OnClick="btnEnviar_Click" />
                                            </form>
                                        </div>
