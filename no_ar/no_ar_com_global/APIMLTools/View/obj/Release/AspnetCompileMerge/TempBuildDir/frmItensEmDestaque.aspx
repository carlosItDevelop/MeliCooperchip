<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmItensEmDestaque.aspx.cs" Inherits="view.frmItensEmDestaque" %>
        ...
        <% Server.Execute("sidebar-direito.aspx"); %>
            ...
            <div id="page-header" class="clearfix">
                <div class="page-header">
                    <h2>HotItems - HomePage</h2>
                    <span class="txt">Destaques da 1ª Página.</span>
                </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><i class="fa fa-list-alt"></i> Anúncios em Destaques na Primeira Página</h4>
                                    </div>
