<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmHistoricoDePgtos.aspx.cs" Inherits="view.frmHistoricoDePgtos" %>
        ...
        <% Server.Execute("sidebar-direito.aspx"); %>
            ...
            <div id="page-header" class="clearfix">
                <div class="page-header">
                    <h2>Pagamentos</h2>
                    <span class="txt">Histórico de Pagamentos.</span>
                </div>
                                        ...
                                        <div style="padding: 10px; margin: 15px 15px;">
                                            ...
                                            <div class="panel panel-default plain toggle panelMove panelClose panelRefresh">
                                                ...
                                                <div class="panel-heading white-bg">
                                                    <h4 class="panel-title">Histórico de Pagamentos:</h4>
                                                </div>
