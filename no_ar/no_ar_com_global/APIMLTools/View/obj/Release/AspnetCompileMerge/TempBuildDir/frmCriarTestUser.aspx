<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCriarTestUser.aspx.cs" Inherits="view.frmCriarTestUser" %>
        ...
        <% Server.Execute("sidebar-direito.aspx"); %>
            ...
            <div id="page-header" class="clearfix">
                <div class="page-header">
                    <h2>User Test</h2>
                    <span class="txt">Criando usuário de testes.</span>
                </div>
                                        ...
                                        <div style="padding: 10px; margin: 15px 15px;">
                                            ...
                                            <div class="panel panel-default plain toggle panelMove panelClose panelRefresh">
                                                ...
                                                <div class="panel-heading white-bg">
                                                    <h4 class="panel-title">Criar Usuário de Teste:</h4>
                                                </div>

                                                <div style="margin: 15px;">
                                                    <form class="form-inline" role="form" runat="server">
                                                        <asp:Button ID="btnEnviar" class="btn btn-primary form-control" runat="server" OnClick="btnEnviar_Click" Text=" Criar Usuário " />
                                                    </form>
                                                </div>
