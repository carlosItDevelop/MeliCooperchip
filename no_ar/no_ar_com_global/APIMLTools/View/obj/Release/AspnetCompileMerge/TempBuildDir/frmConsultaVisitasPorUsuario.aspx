<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmConsultaVisitasPorUsuario.aspx.cs" Inherits="view.frmConsultaVisitasPorUsuario" %>
        ...
        <% Server.Execute("sidebar-direito.aspx"); %>
            ...
            <div id="page-header" class="clearfix">
                <div class="page-header">
                    ...
                    <span class="txt">Busca visitas por usuário.</span>
                </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><i class="fa fa-list-alt"></i> APIML | Tools - Lista visitas</h4>
                                    </div>
                                    <div class="panel-body pt0 pb0">
                                        ...
                                        <div style="padding: 10px; margin: 15px 15px;">
                                            <form class="form-inline" role="form" runat="server">
                                                    <label class="control-label" for="">Visitas para o usuário:</label>
                                                    <asp:TextBox ID="txtBuscaProduto"  CssClass="form-control" runat="server" placeholder="Digite o código do usuário...">59181149</asp:TextBox>
                                                    <asp:Button CssClass="btn btn-success ml10" ID="btnBuscar" runat="server" Text=":: Buscar ::" OnClick="btnEnviar_Click" />
                                            </form>
                                        </div>
