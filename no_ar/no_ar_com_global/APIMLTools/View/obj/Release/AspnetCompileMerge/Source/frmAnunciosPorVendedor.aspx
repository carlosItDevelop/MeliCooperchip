<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAnunciosPorVendedor.aspx.cs" Inherits="view.frmAnunciosPorVendedor" %>
        ...
        <% Server.Execute("sidebar-direito.aspx"); %>
            ...
            <div id="page-header" class="clearfix">
                <div class="page-header">
                    <h2>Busca Anúncios</h2>
                    <span class="txt">Busca Anúncios por Vendedor.</span>
                </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><i class="fa fa-list-alt"></i> APIML | Tools - Busca Anúncios</h4>
                                    </div>
                                    <div class="panel-body pt0 pb0">
                                        ...
                                        <div style="padding: 10px; margin: 15px 15px;">
                                            <form class="form-inline" role="form" runat="server">
                                                    <label class="control-label" for="">Busca Anúncios por Vendedor:</label>&nbsp;&nbsp;
                                                    <asp:TextBox ID="txtSeller" CssClass="form-control" runat="server"></asp:TextBox>
                                                    <asp:Button CssClass="btn btn-success ml10" ID="btnBuscaAnuncio" runat="server" Text=":: Buscar ::" OnClick="btnBuscaAnuncio_Click" />
                                            </form>
                                        </div>
