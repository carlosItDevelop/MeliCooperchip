<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmQualificacaoFeitaERecebida.aspx.cs" Inherits="view.frmQualificacaoFeitaERecebida" %>
...
<html class="no-js">
    ...
    <body>
        ...
        <% //Server.Execute("page-nav.aspx"); %><% Server.Execute("page-mynav.aspx"); %>        <% Server.Execute("menu_principal.aspx"); %><% Server.Execute("sidebar-direito.aspx"); %>

            <div id="page-header" class="clearfix">
                <div class="page-header">
                    <h2>Qualificações</h2>
                    <span class="txt">Qualificações Feitas e Recebidas.</span>
                </div>
                                        ...
                                        <div style="padding: 10px; margin: 15px 15px;">
                                            ...
                                            <div class="panel panel-default plain toggle panelMove panelClose panelRefresh">
                                                ...
                                                <div class="panel-heading white-bg">
                                                    <h4 class="panel-title">Qualificações:</h4>
                                                </div>

                                                <div style="margin: 15px;">
                                                    <form class="form-inline" role="form" runat="server">
                                                        <asp:TextBox ID="txtQualifyForOrder" class="form-control" runat="server">780058233</asp:TextBox>
                                                        <asp:Button ID="btnEnviar" CssClass="btn btn-primary form-control" runat="server" OnClick="btnEnviar_Click" Text=".:: Listar ::." />
                                                    </form>
                                                </div>
