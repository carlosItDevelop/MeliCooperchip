...
$(document).ready(function() {
    ...
    document.querySelector('.sweet-5').onclick = function(){
        swal({
          title: "Voce esta certo disso?",
          text: "Voce nao podera recuperar este arquivo!",
          type: "warning",
          showCancelButton: true,
          confirmButtonClass: 'btn-danger',
          confirmButtonText: 'Sim, Delete!',
          cancelButtonText: "Nao, Cancele!",
          closeOnConfirm: false,
          closeOnCancel: false
        },
        function(isConfirm){
          ...
          if (isConfirm){
            swal("Deletado!", "Seu arquivo imaginario foi deletado!", "success");
          } else {
            swal("Cancelado", "Seu arquivo imaginario esta seguro :)", "error");
          }
        });
    };
    ...
    document.querySelector('.sweet-7').onclick = function () {
        swal({
            title: "Teste com mais um modal - Sweet 7?",
            text: "Simulacao de exclusao de arquivo!",
            type: "warning",
            showCancelButton: true,
            confirmButtonClass: 'btn-danger',
            confirmButtonText: 'Sim, Delete!',
        ...
        function (isConfirm) {
            ...
            if (isConfirm) {
                ...
                swal({
                    title: "Ok!",
                    text: "Seu arquivo imaginario foi deletado.",
                    imageUrl: 'img/thumbs-up.jpg'
                });
                //swal("Deletado!", "Seu arquivo imaginario foi deletado!", "success");
            } else {
