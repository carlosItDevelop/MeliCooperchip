<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetPostForRecebeNotificacoes.aspx.cs" Inherits="view.SetPostForRecebeNotificacoes" %>
    ...
    <body>
        ...
        <div id="page-header" class="clearfix">
            <div class="page-header">
                ...
                <span class="txt">Simulador de Notificações ML</span>
            </div>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                ...
                <!-- AQUI DEVEM ENTRAR AS PERSONALIZAÇÕES /-->
                            ...
                            <form runat="server" id="frmNotML"><asp:Button ID="btnEnviar" runat="server" Text="Enviar Post" OnClick="btnEnviar_Click" style="height: 26px" /></form>
