        ...
        <div class="container login-container">
            <div class="login-panel panel panel-default plain animated bounceIn">
                    ...
                    <form class="form-horizontal mt0" action="login.aspx" id="register-form" role="form">
                        ...
                        <div class="form-group">
                            <div class="col-lg-12">
                                ...
                                <div class="input-group input-icon">
                                    <span class="input-group-addon"><i class="fa fa-key"></i></span>
                                    <input type="password" name="password1" id="password1" class="form-control" placeholder="Redigite sua senha">
                                </div>
                            </div>
                        </div>
                ...
                <div class="panel-footer gray-lighter-bg bt">
                    <h4 class="text-center"><strong>Já tem uma conta ?</strong>
                    </h4>
                    <p class="text-center"><a href="login.aspx" class="btn btn-primary">Entrar</a>
                    </p>
                </div>
            </div>
            <!-- End .panel -->
