<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmListaResumidaPedFech21OrNotQualify.aspx.cs" Inherits="View.FrmListaResumidaPedFech21OrNotQualify" %>
        ...
        <% Server.Execute("menu_principal.aspx"); %>    <% Server.Execute("sidebar-direito.aspx"); %>
            ...
            <div id="page-header" class="clearfix">
                <div class="page-header">
                    <h2>Resumo Pedidos Fechados</h2>
                    <span class="txt">Menos de 21 dias ou Não qualificados.</span>
                </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title"><i class="fa fa-list-alt"></i> APIML | Tools - Management - Lista / Resumo - Pedidos Fechados</h4>
                    </div>
                    <div class="col-lg-12 col-md-12"><!-- DIV 003 / -->
