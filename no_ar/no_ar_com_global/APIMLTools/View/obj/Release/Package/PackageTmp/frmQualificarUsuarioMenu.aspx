<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmQualificarUsuarioMenu.aspx.cs" Inherits="View.FrmQualificarUsuarioMenu" %>
        ...
        <% Server.Execute("menu_principal.aspx"); %>    <% Server.Execute("sidebar-direito.aspx"); %>
            ...
            <div id="page-header" class="clearfix">
                <div class="page-header">
                    <h2>Qualificação</h2>
                    <span class="txt">Qualificar Usuário.</span>
                </div>
                                        ...
                                        <div style="padding: 10px; margin: 15px 15px;">
                                            ...
                                            <div class="panel panel-default plain toggle panelMove panelClose panelRefresh">
                                                ...
                                                <div class="panel-heading white-bg">
                                                    <h4 class="panel-title">Qualificar Usuário:</h4>
                                                </div>

                                                <div style="margin: 15px;">
                                                    <form class="form-inline" role="form" runat="server">
                                                        
                                                        <asp:DropDownList ID="cboUsuariosParaQualificar" runat="server">
                                                            <asp:ListItem Value="todos">&lt;&lt; TODOS &gt;&gt;</asp:ListItem>
                                                        </asp:DropDownList>

                                                        <asp:Button ID="btnEnviar" CssClass="btn btn-primary form-control" runat="server" OnClick="btnEnviar_Click" Text=" Enviar " />
                                                    </form>
                                                </div>
