...
namespace SDK {
	public static class Util {
		...
		public static string GetNick(int sellerid, Meli m) {
			string vCliente = "";
		   // m = new Meli(Convert.ToInt64(Application["APPID"]), Application["SECRETKEY"].ToString(), Session["aToken"].ToString());
        ...
        //public static string GetTitleItems(this Meli m, string vItemID) {
