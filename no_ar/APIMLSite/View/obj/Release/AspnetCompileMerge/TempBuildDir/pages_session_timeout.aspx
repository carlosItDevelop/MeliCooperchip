<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pages_session_timeout.aspx.cs" Inherits="SimpleMembershipLocalDatabase.pages_session_timeout" %>
...
<!-- Mirrored from preview.oklerthemes.com/porto-admin/1.4.0/pages-session-timeout.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Apr 2015 00:25:02 GMT -->
<head>

		<!-- Basic -->
		<meta charset="utf-8" />
		<title>APIML | Tools - Management (Session Timeout)</title>		
		...
		<section class="body">
			...
			<header class="header">
				...
				<div class="header-right">
					...
					<form action="http://preview.oklerthemes.com/porto-admin/1.4.0/pages-search-results.html" class="search nav-form">
...
<!-- Mirrored from preview.oklerthemes.com/porto-admin/1.4.0/pages-session-timeout.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Apr 2015 00:25:03 GMT -->
</html>