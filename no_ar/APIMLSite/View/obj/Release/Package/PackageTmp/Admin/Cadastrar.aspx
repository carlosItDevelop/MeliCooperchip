<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cadastrar.aspx.cs" Inherits="SimpleMembershipLocalDatabase.pages_signup" %>
...
<!-- Mirrored from preview.oklerthemes.com/porto-admin/1.4.0/pages-signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Apr 2015 00:25:02 GMT -->
<head>

		<!-- Basic -->
		<meta charset="utf-8" />
		<title>APIML | Tools - Management (Registre-se)</title>		
			...
			<div class="center-sign">
				...
				<div class="panel panel-sign">
					<div class="panel-title-sign mt-xl text-right">
						<h2 class="title text-uppercase text-bold m-none"><i class="fa fa-user mr-xs"></i> Registre-se</h2>
					</div>
					<div class="panel-body">
						<form id="formCadastrar" runat="server">
							<div class="form-group mb-lg">
								<label>Nome Completo</label>
                                <asp:TextBox runat="server" ID="txtNome" CssClass="form-control input-lg" placeholder="Nome completo" />
							</div>
							...
							<div class="form-group mb-none">
								<div class="row">
									...
									<div class="col-sm-6 mb-lg">
                                        ...
                                        <!-- Este campo não está sendo tratado /-->
                                        <asp:TextBox runat="server" ID="txtConfirmaSenha" TextMode="Password" CssClass="form-control input-lg" placeholder="Confirme a Senha" />
                                        <!-- Este campo não está sendo tratado /-->
							...
							<div class="row cl-lg-12">
								<div class="col-sm-6 text-right">
                                    <asp:Button Text="Resgistrar-se" runat="server" ID="btnCadastrar" CssClass="btn btn-facebook mb-md ml-xs mr-xs" OnClick="btnCadastrar_Click" />
								</div>
...
<%--							<span class="mt-lg mb-lg line-thru text-center">
								<span> Perfil </span>
							</span>                            
                            --%>
						    <br/>
							<div class="row" style="text-align: center;">
								<div class="form-group" style="text-align: center;">
									<div class="checkbox-custom checkbox-default col-sm-6">
                                        <label>
                                            <asp:CheckBox runat="server" ID="chkAdmin"/> Administrador
                                        </label>
									</div>

    								<div class="checkbox-custom checkbox-default col-sm-6">
                                        <label>
                                            <asp:CheckBox runat="server" ID="chkUser"/> Usuário
                                        </label>
	    							</div>
								</div>
							</div> 
