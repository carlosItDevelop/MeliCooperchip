<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAnunciosPorCategoria.aspx.cs" Inherits="View.FrmAnunciosPorCategoria" %>
        ...
        <% Server.Execute("menu_principal.aspx"); %>    <% Server.Execute("sidebar-direito.aspx"); %>
            ...
            <div id="page-header" class="clearfix">
                <div class="page-header">
                    ...
                    <span class="txt">Tabela com os anúncios por Categoria.</span>
                </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><i class="fa fa-list-alt"></i> Tabela com os anúncios por Categoria</h4>
                                    </div>
                                    <div class="panel-body pt0 pb0">
                                        ...
                                        <div style="padding: 10px; margin: 15px 15px;">
                                            <form class="form-inline" role="form" runat="server">
                                                    <label class="col-lg-2 col-md-3 control-label" for="">Escolha a Caegoria:</label>
                                                    <asp:DropDownList CssClass="fancy-select form-control" ID="cboListaCategoria" runat="server"></asp:DropDownList>
