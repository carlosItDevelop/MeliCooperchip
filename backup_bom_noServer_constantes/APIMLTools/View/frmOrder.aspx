<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmOrder.aspx.cs" Inherits="View.FrmOrder" %>
        ...
        <% Server.Execute("menu_principal.aspx"); %>    <% Server.Execute("sidebar-direito.aspx"); %>
            ...
            <div id="page-header" class="clearfix">
                <div class="page-header">
                    <h2>Pedido por ID</h2>
                    <span class="txt">Pedidos por ID.</span>
                </div>
                                     ...
                                     <div style="padding: 10px; margin: 15px 15px;">
                                        ...
                                        <div class="panel panel-default plain toggle panelMove panelClose panelRefresh">
                                            ...
                                            <div class="panel-body table">
                                                ...
                                                <div>
                                                <form id="formOrder" action="" runat="server">
                                                    <asp:TextBox ID="txtId" runat="server">766479610</asp:TextBox>
                                                    <asp:Button ID="btnBuscarOrder" runat="server" OnClick="btnBuscarOrder_Click" Text=" Listar Order " />
                                                    <br />
                                                    <br />
                                                    ...
                                                    <br />
                                                    <br />
                                                    <asp:Label ID="lblResultadoAlinhado" runat="server"></asp:Label>
                                                    <br />
                                                    <br />
                                                    <br />
                                                    <asp:Label ID="lblResultadoObjeto" runat="server"></asp:Label>
                                                </form>
                                                </div>
