<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mycustompage.aspx.cs" Inherits="View.Mycustompage" %>
    ...
    <body>
        ...
        <div id="page-header" class="clearfix">
            <div class="page-header">
                ...
                <span class="txt">Contate o administrador!</span>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                    ...
                    <p>Contate o administrador do sistema. Este erro acontece apenas remotamente. Peça ao administrador que faça um Debug no sistema!</p>
                    <p /><h4>Equipe APIML | Tools - Management</h4>
