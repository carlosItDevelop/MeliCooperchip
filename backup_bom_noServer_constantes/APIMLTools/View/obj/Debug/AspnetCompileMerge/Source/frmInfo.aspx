<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmInfo.aspx.cs" Inherits="View.FrmInfo" %>
    ...
    <body>
        ...
        <div id="page-header" class="clearfix">
            <div class="page-header">
                ...
                <span class="txt">Context, Applications, etc...</span>
            </div>
            ...
            <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                ...
                <!-- AQUI DEVEM ENTRAR AS PERSONALIZAÇÕES /-->
                        ...
                        <div style="padding: 10px; margin: 15px 15px;">
                            <div class="heading">
                                <h3>Informações gerais de Sistemas, entre outras...</h3>
                            </div>
                            <div><asp:Label ID="lblResult" Text="Testando label" runat="server"></asp:Label></div>    
                        </div>                      
                    </div>
                </div>
            </div>
