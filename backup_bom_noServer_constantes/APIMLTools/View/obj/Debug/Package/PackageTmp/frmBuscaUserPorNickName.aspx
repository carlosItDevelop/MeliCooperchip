<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmBuscaUserPorNickName.aspx.cs" Inherits="View.FrmBuscaUserPorNickName" %>
        ...
        <% Server.Execute("menu_principal.aspx"); %>    <% Server.Execute("sidebar-direito.aspx"); %>
            ...
            <div id="page-header" class="clearfix">
                <div class="page-header">
                    <h2>Busca Usuários</h2>
                    <span class="txt">Busca usuários por Apelido.</span>
                </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><i class="fa fa-list-alt"></i> APIML | Tools - Busca Usuários</h4>
                                    </div>
                                    <div class="panel-body pt0 pb0">
                                        ...
                                        <div style="padding: 10px; margin: 15px 15px;">
                                            <form class="form-inline" role="form" runat="server">
                                                    <label class="control-label" for="">Busca Perfil de usuários pelo Apelido:</label>
                                                    <asp:TextBox ID="txtBuscaPorApelido"  CssClass="form-control" runat="server" placeholder="Digite o Apelido"></asp:TextBox>
                                                    <asp:Button CssClass="btn btn-success ml10" ID="btnBuscar" runat="server" Text=":: Buscar ::" OnClick="btnBuscar_Click" />
                                            </form>
                                        </div>
