<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="head.aspx.cs" Inherits="View.Head" %>
...
<title><% Response.Write(ConfigurationManager.AppSettings["APPNAME"]); %></title>
       <meta charset="utf-8">
        ...
        <!-- EU COLOQUEI /-->
        <link href="css/cooperchip/table_blue_white.css" rel="stylesheet" />
        <link href="css/bootstrap-responsive.css" rel="stylesheet" />
        <!-- ESTILOS PERSONALIZADOS POR MIM/-->
