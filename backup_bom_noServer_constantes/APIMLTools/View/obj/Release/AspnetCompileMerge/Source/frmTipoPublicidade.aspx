<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmTipoPublicidade.aspx.cs" Inherits="view.frmTipoPublicidade" %>
        ...
        <% Server.Execute("sidebar-direito.aspx"); %>
            ...
            <div id="page-header" class="clearfix">
                <div class="page-header">
                    <h2>Tipo de Publicidade</h2>
                    <span class="txt">Tipos de Publicidades no ML.</span>
                </div>
                                     ...
                                     <div style="padding: 10px; margin: 15px 15px;">
                                        ...
                                        <div class="panel panel-default plain toggle panelMove panelClose panelRefresh">
                                            ...
                                            <div class="panel-heading white-bg">
                                                <h4 class="panel-title">Publicidades:</h4>
                                            </div>
