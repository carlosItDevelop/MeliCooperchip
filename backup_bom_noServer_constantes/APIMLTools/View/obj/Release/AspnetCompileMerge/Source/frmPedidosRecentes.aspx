<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmPedidosRecentes.aspx.cs" Inherits="view.frmPedidosRecentes" %>
        ...
        <% Server.Execute("sidebar-direito.aspx"); %>
            ...
            <div id="page-header" class="clearfix">
                <div class="page-header">
                    ...
                    <span class="txt">Pedidos ativos recentes.</span>
                </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><i class="fa fa-list-alt"></i> APIML | Tools - Pedidos Recentes</h4>
                                    </div>
