<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmGetPerfilSellers.aspx.cs" Inherits="view.frmGetPerfilSellers" %>
    ...
    <body>
        ...
        <div id="page-header" class="clearfix">
            <div class="page-header">
                <h2>Anúncio por ID</h2>
                <span class="txt">Anúncio Específico</span>
            </div>
                ...
                <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                    ...
                    <div style="padding: 10px; margin: 15px 15px;">
                        <form class="form-inline" role="form" runat="server">        
                                    ...
                                    <label class="col-lg-2 col-md-3 control-label" for="">ID do Usuário:</label>
                                    <asp:TextBox CssClass="form-control"  ID="txtSellerId" runat="server" placeholder="Seller ID aqui..." ></asp:TextBox>
                                    <asp:Button CssClass="btn btn-success ml10" ID="btnBuscaUsuario" runat="server" OnClick="btnBuscaUsuario_Click" Text=".:: Busca Usuário ::." />
