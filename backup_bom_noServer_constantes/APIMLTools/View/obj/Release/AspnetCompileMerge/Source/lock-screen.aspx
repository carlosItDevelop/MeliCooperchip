<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lock-screen.aspx.cs" Inherits="view.lock_screen" %>
            ...
            <div class="login-panel panel panel-default plain animated bounceIn">
                ...
                <div class="panel-body pt0">
                    <div class="user-avatar">
                        <img src="img/avatars/128.jpg" alt="user">
                    </div>
                    <form class="form-horizontal" action="default.aspx" id="login-form" role="form">
                ...
                <div class="panel-footer gray-lighter-bg bt">
                    <h4 class="text-center"><strong>Bem vindo</strong>
                    </h4>
                    <p class="text-center"><a href="login.aspx" class="btn btn-primary">Não é você ?</a>
                    </p>
                </div>
            </div>
            <!-- End .panel -->
