<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmPedidosArquivados.aspx.cs" Inherits="view.frmPedidosArquivados" %>
        ...
        <% Server.Execute("sidebar-direito.aspx"); %>
            ...
            <div id="page-header" class="clearfix">
                <div class="page-header">
                    <h2>Arquivados</h2>
                    <span class="txt">Pedidos Arquivados.</span>
                </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><i class="fa fa-list-alt"></i> APIML | Tools - <strong>Pedidos Arquivados</strong></h4>
                                    </div>
