<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmOrderDetail.aspx.cs" Inherits="view.frmOrderDetail" %>
        ...
        <% Server.Execute("sidebar-direito.aspx"); %>
            ...
            <div id="page-header" class="clearfix">
                <div class="page-header">
                    <h2>Pedidos Detalhe</h2>
                    <span class="txt">Detalhes de um pedido específico.</span>
                </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title"><i class="fa fa-list-alt"></i> APIML | Tools - Management / <strong>Order Detail</strong></h4>
                    </div>
