<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmMostraFretePelasDimensoes.aspx.cs" Inherits="View.FrmMostraFretePelasDimensoes" %>
        ...
        <% Server.Execute("menu_principal.aspx"); %>    <% Server.Execute("sidebar-direito.aspx"); %>
            ...
            <div id="page-header" class="clearfix">
                <div class="page-header">
                    <h2>Calcula Frete pelas Dimensões</h2>
                    <span class="txt">Resource de cálculo de fretes pelas dimensões.</span>
                </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title"><i class="fa fa-list-alt"></i> APIML | Tools - Cálculo de frete pela Dimensão</h4>
                        </div>
