<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmListaProdutosComparacao.aspx.cs" Inherits="View.FrmListaProdutosComparacao" %>
        ...
        <% Server.Execute("menu_principal.aspx"); %>    <% Server.Execute("sidebar-direito.aspx"); %>
            ...
            <div id="page-header" class="clearfix">
                <div class="page-header">
                    <h2>Comparação</h2>
                    <span class="txt">Comparação de preços.</span>
                </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><i class="fa fa-list-alt"></i> APIML | Tools - Comparação<strong>Lista de Produtos Para Comparação de Preços e Quantidades</strong></h4>
                                    </div>
                                        ...
                                        <div style="padding: 10px; margin: 15px 15px;">
                                            <form class="form-inline" role="form" runat="server">
                                                    <label class="control-label" for="">Escolha:  </label>&nbsp;&nbsp;
                                                        ...
                                                        <asp:DropDownList CssClass="fancy-select form-control" ID="cboListaCategoria" runat="server">
